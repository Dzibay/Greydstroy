...
const DEFAULT_META = {
  ...
  description:
    'Завод металлоконструкций в Дзержинске: изготовление на заказ, монтаж на объекте, бетонные работы, проектирование КМ/КМД и строительство зданий под ключ. Расчёт за 1 рабочий день, отгрузка по всей России.',
}
