  ...
  routes: [
    { path: '/', name: 'home', component: HomePage },
    {
      ...
      meta: {
        ...
        description:
          'Металлоконструкции на заказ: каркасы зданий, фермы, балки, лестницы, навесы, ангары. Работы от 39 000 ₽/т, монтаж с окраской от 35 000 ₽/т, смета за 1 рабочий день, отгрузка по всей России.',
      },
    },
    ...(() => {
    ...
    },
    {
      ...
      meta: {
        ...
        description:
          'Контакты ООО «Грэйдстрой»: +7 (905) 664-66-65, greydstroy.m@yandex.ru. Производство металлоконструкций: г. Дзержинск, дорога Заревская объездная, д. 9В. Расчёт заказа за 1 рабочий день.',
      },
    },
    {
      path: '/dostavka',
