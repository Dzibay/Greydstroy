    ...
    <div class="container hero-in">
      <div class="hero-left">
        ...
        <h1 class="hero-title" v-reveal="80">
          Произведем <em>«Под ключ»</em> любой заказ из металла
        </h1>

        <p class="hero-sub" v-reveal="160">
          Вместо 3х подрядчиков, одно производство с резкой, гибкой и сваркой.
          От одной детали до возведения промышленного объекта
        </p>
